...
qrcode.echo = function(info){
    qrcode.result = null;
    qrcode.status = 1;
    try{
        var image_height = info.height;
        var image_width = info.width;
        var image_data = info.data;
        var nheight = image_height;
        var nwidth = image_width;
        if(image_width*image_height>qrcode.maxImgSize)
        {
            var ir = image_width / image_height;
    ...
    if(qrcode.callback!==null)
        qrcode.callback(qrcode.status,qrcode.result);
};
